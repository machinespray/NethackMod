	...
	public void register() {
		...
		item = new ItemBlock(this) {
			...
			public void addInformation(ItemStack stack, EntityPlayer playerIn,
				...
				if (type != 1) {
					tooltip.add("Place a Brewing Stand with Water Bottles in it above this altar for a chance to recieve gifts upon sacrificing.");
				} else {
					tooltip.add("Sacrifice gold at this altar for a chance to recieve gifts upon sacrificing.");
				}
			}
		};
		item.setRegistryName(new ResourceLocation("royal", this
				.getUnlocalizedName() + "Altar"));
